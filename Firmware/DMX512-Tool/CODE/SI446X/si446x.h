...
#define  RF_SIZE      64 //0-64, if = 0: variable mode, else: fixed mode

#define   SI446X_CS    PAout(4)
#define   SI446X_RST   PBout(1)
...
extern void SI446X_PART_INFO(u8 *buffer);

/*Read the FUNC_INFO of the device, 7 bytes needed*/
extern void SI446X_FUNC_INFO(u8 *buffer);

/*Send a command to the device*/
extern void SI446X_CMD(u8 *cmd, u8 cmdsize);

/*Read the INT status of the device, 9 bytes needed*/
extern void SI446X_INT_STATUS(u8 *buffer);

/*Read the PROPERTY of the device*/
extern void SI446X_GET_PROPERTY_X(SI446X_PROPERTY GROUP_NUM, u8 NUM_PROPS, u8 *buffer);

/*configuration the device*/
extern void SI446X_CONFIG_INIT(void);

/*reset the SI446x device*/
extern void SI446X_RESET(void);

/*write data to TX fifo*/
extern void SI446X_W_TX_FIFO(u8 *txbuffer, u8 size);

/*start TX command*/
extern void SI446X_START_TX(u8 channel, u8 condition, u16 tx_len);

/*read RX fifo*/
extern u8 SI446X_READ_PACKET(u8 *buffer);

/*start RX state*/
extern void SI446X_START_RX(u8 channel, u8 condition, u16 rx_len, u8 n_state1, u8 n_state2, u8 n_state3);

/*read packet information*/
extern void SI446X_PKT_INFO(u8 *buffer, u8 FIELD, u16 length, u16 diff_len);

/*read fifo information*/
extern void SI446X_FIFO_INFO(u8 *buffer);

/*Power up the device*/
extern void SI446X_POWER_UP(u32 f_xtal);

/*send a packet*/
extern void SI446X_SEND_PACKET(u8 *txbuffer, u8 size, u8 channel, u8 condition);

/*Set the PROPERTY of the device*/
extern void SI446X_SET_PROPERTY_X(SI446X_PROPERTY GROUP_NUM, u8 NUM_PROPS, u8 *PAR_BUFF);

/*Read the PROPERTY of the device*/
extern void SI446X_GET_PROPERTY_X(SI446X_PROPERTY GROUP_NUM, u8 NUM_PROPS, u8 *buffer );

/*config the CRC, PROPERTY 0x1200*/
extern void SI446X_CRC_CONFIG(u8 PKT_CRC_CONFIG);

/*Get the PROPERTY of the device, only 1 byte*/
extern u8 SI446X_GET_PROPERTY_1(SI446X_PROPERTY GROUP_NUM);

/*Set the PROPERTY of the device, only 1 byte*/
extern void SI446X_SET_PROPERTY_1(SI446X_PROPERTY GROUP_NUM, u8 proirity);

/*config the GPIOs, IRQ, SDO*/
extern void SI446X_GPIO_CONFIG(u8 G0, u8 G1, u8 G2, u8 G3, u8 IRQ, u8 SDO, u8 GEN_CONFIG);

/*reset the RX FIFO of the device*/
extern void SI446X_RX_FIFO_RESET(void);

/*reset the TX FIFO of the device*/
extern void SI446X_TX_FIFO_RESET(void);

/*change a new state*/
extern void SI446X_CHANGE_STATE(u8 NewState);

/*Get the chip status*/
extern void SI446X_CHIP_STATUS(u8* buffer_8);

/*Set the SYNC bytes of the device*/
extern void SI446X_SET_SYNC(u32 sync);

/*Set the PA Power of the device*/
extern void SI446X_SET_POWER(u8 Power_Level);

extern u8 SI446X_GET_DEVICE_STATE(void);
