...
#define OS_TASK_STAT_EN           0    //允许 (1) 或者禁止 (0) 统计任务
...
#define OS_CPU_HOOKS_EN           1    //在处理器移植文件中允许使用 uC/OS-II 的接口函数
                                       ...
                                       // ----------------------- 事件标志管理 ------------------------ 
#define OS_FLAG_EN                0    //允许 (1) 或者禁止 (0) 产生事件标志相关代码
...
#define OS_FLAG_QUERY_EN          1    //允许生成 OSFlagQuery() 
                                       ...
                                       // -------------------- 消息邮箱管理--------------------- 
#define OS_MBOX_EN                0    //允许 (1) 或者禁止 (0) 产生消息邮箱相关代码
...
#define OS_MBOX_QUERY_EN          1    //允许生成 OSMboxQuery()
                                       ...
                                       // ---------------------内存管理  -------------------- 
#define OS_MEM_EN                 0    //允许 (1) 或者禁止 (0) 产生内存相关代码
#define OS_MEM_QUERY_EN           1    //允许生成 OSMemQuery() 


                                       // ---------------- 互斥型信号量管理 --------------- 
#define OS_MUTEX_EN               0    //允许 (1) 或者禁止 (0) 产生互斥型信号量相关代码
...
#define OS_MUTEX_QUERY_EN         1    //允许生成 OSMutexQuery() 
                                       ...
                                       // ---------------------- 消息队列号管理 ---------------------- 
#define OS_Q_EN                   0    //允许 (1) 或者禁止 (0) 产生消息队列相关代码
